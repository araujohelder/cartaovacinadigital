...
class _CreatePageState extends State<CreatePage> {
                ...
                child: Container(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        buildInputTextNome(
                            "Nome", Icons.person, _nameController),
                        buildInputTextEmail(
                            "Email", Icons.email, _emailController),
                        buildInputPassword(
                            "Senha", Icons.vpn_key, _passwordController),
                        buildInputConfirmPassword(
                            "Confirmar Senha",
                            Icons.vpn_key,
  ...
  Widget buildInputConfirmPassword(
      String label,
      IconData icon,
